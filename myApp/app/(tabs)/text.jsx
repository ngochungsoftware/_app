...
//             try {
//                 // Sử dụng id để fetch chi tiết sản phẩm
//                 const response = await fetch(`http://192.168.1.150:8080/api/v1/productDetails/${productId}`);
...
export default function ProductDetailScreen() {
    ...
    //     try {
    //         const response = await axios.get(`/productDetails/product-detail-of-product/${productid}`);
    //         if (response?.data) {
    //             setListProductDetail(response.data);
    //             setPriceRange(calculatePriceRange(response.data));
    //         }
